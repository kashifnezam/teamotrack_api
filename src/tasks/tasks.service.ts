...
export class TasksService {
    ...
    async update(
        ...
        if (
            ...
            if (
                 ...
                 */
                await this.verifyTaskAssignment(
                    user,
                    task,
                    dto.assignedTo,
                );
        ...
        this.logger.log(
            `Task updated | id=${id} | user=${userId}`,
        );
    ...
    async remove(
        ...
        this.logger.log(
            `Task deleted | id=${id} | user=${userId}`,
        );
    ...
    private async verifyTaskAssignment(
        user: any,
        task: any,
        executiveId: string,
    ) {
