(function () {
    ...
    function render() {
        ...
        if (
            ...
            $('salaryAssignmentEmpty')
                .classList
                .remove('d-none');

            $('salaryAssignmentTableWrap')
                .classList
                .add('d-none');

            $('salaryAssignmentMobileList')
                .classList
                .add('d-none');
        ...
        try {
            ...
            employees =
                Array.isArray(
                    ...
                    ? employeeResponse
                    : employeeResponse?.executives ||
                      employeeResponse?.users ||
                      [];
    ...
    function resetForm() {
        ...
        $('salaryAssignmentModalTitle')
            .textContent =
            'Assign Salary';


        $('saveSalaryAssignmentBtn')
            .textContent =
            'Assign Salary';
    ...
    window.deactivateSalaryAssignment =
        async function (
            id,
        ) {
            ...
            const confirmed =
                await AppAlert.confirm(
                    'Deactivate this salary assignment?',
                );
            ...
            try {
                ...
                AppAlert.loading(
                    'Deactivating salary assignment...',
                );


                await Api.patch(
                    `/salary-assignments/${id}/deactivate`,
                    {},
                );
                ...
                AppAlert.success(
                    'Salary assignment deactivated successfully',
                );
                ...
                AppAlert.error(
                    error?.message ||
                    'Failed to deactivate salary assignment',
                );
    ...
    window.initializeSalaryAssignmentsPage =
        async function () {
