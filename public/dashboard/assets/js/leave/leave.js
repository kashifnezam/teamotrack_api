...
(() => {
    ...
    async function handleLeaveTypeAction(
        event
    ) {
    ...
    async function deactivateLeaveType(
        id
    ) {
    ...
    async function reactivateLeaveType(
        id
    ) {
        ...
        try {
            ...
            AppAlert.loading(
                'Reactivating leave type...'
            );


            await Api.patch(
                `/leave/types/${id}/reactivate`,
                {}
            );
            ...
            AppAlert.error(
                error?.message ||
                'Failed to reactivate leave type'
            );
