(function () {
    ...
    function render() {
        ...
        if (!structures.length) {
            ...
            $('salaryStructureEmpty')
                .classList
                .remove('d-none');

            $('salaryStructureTableWrap')
                .classList
                .add('d-none');

            $('salaryStructureMobileList')
                .classList
                .add('d-none');
    ...
    function resetForm() {
        ...
        $('salaryStructureModalTitle')
            .textContent =
            'Add Salary Structure';


        $('saveSalaryStructureBtn')
            .textContent =
            'Save Structure';
    ...
    window.deactivateSalaryStructure =
        async function (
            id,
        ) {
    ...
    window.reactivateSalaryStructure =
        async function (
            id,
        ) {
            ...
            const confirmed =
                await AppAlert.confirm(
                    'Reactivate this salary structure?',
                );
            ...
            try {
                ...
                AppAlert.loading(
                    'Reactivating salary structure...',
                );


                await Api.patch(
                    `/salary-structures/${id}/reactivate`,
                    {},
                );
                ...
                AppAlert.success(
                    'Salary structure reactivated successfully',
                );
                ...
                AppAlert.error(
                    error?.message ||
                    'Failed to reactivate salary structure',
                );
    ...
    window.initializeSalaryStructuresPage =
        async function () {
