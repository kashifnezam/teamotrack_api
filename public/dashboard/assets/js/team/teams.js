...
window.addEventListener("commonReady", initializeTeamsPage);


async function initializeTeamsPage() {

    console.log("Teams: common.js is ready");
...
function populateShifts() {
    ...
    const message =
        document.getElementById("noShiftMessage");
...
async function deleteTeam(id) {
    ...
    const confirmed =
        await Swal.fire({
            title: "Delete team?",
            text: `"${team.name}" will be permanently deleted.`,
            icon: "warning",
